        ...
        <div class="d-flex align-items-center flex-wrap mr-1">
            ...
            <div class="d-flex align-items-baseline flex-wrap mr-5">
                ...
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                    ...
                    <li class="breadcrumb-item text-muted">
                        <a href="{{ route('mechanic.create') }}" class="text-muted">Add Mechanic &nbsp;</a>
                    </li>
                </ul>
                <!--end::Breadcrumb-->
            </div>
    ...
    <form action="{{route('mechanic.store')}}" method="post" enctype="multipart/form-data">
        ...
        <div class="card-body fs-6 text-gray-700">
            ...
            <div class="mb-5">
                ...
                <textarea name="expertise" id="expertise" class="form-control" required placeholder="Input mechanic expertise">{{{old('expertise')}}}</textarea>
            </div>

            <div class="footer d-flex justify-content-end py-10">
                <div class="d-flex justify-content-end">
                    <a href="{{route('mechanic.index')}}" id="cancelButton"
